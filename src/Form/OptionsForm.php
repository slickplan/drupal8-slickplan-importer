...
class OptionsForm extends FormBase
{
    ...
    public function buildForm(array $form, FormStateInterface $form_state)
    {
        ...
        $title = (isset($xml['settings']['title']) and $xml['settings']['title']) ? $xml['settings']['title'] : (isset($xml['title']) ? $xml['title'] : '');
    ...
    public function submitForm(array &$form, FormStateInterface $form_state)
    {
        ...
        if (isset($form_data['values']['slickplan_importer_site_title']) and $form_data['values']['slickplan_importer_site_title']) {
            $title = (isset($xml['settings']['title']) and $xml['settings']['title']) ? $xml['settings']['title'] : (isset($xml['title']) ? $xml['title'] : '');
            variable_set('site_name', $title);
        }
        
        if (isset($form_data['values']['slickplan_importer_slogan'], $xml['settings']['tagline']) and $form_data['values']['slickplan_importer_slogan'] and $xml['settings']['tagline']) {
            variable_set('site_slogan', $xml['settings']['tagline']);
        }
        
        $xml['import_options'] = array(
            'titles' => isset($form_data['values']['slickplan_importer_page_title']) ? $form_data['values']['slickplan_importer_page_title'] : '',
            'content' => isset($form_data['values']['slickplan_importer_content']) ? $form_data['values']['slickplan_importer_content'] : '',
            'content_files' => (isset($form_data['values']['slickplan_importer_content'], $form_data['values']['slickplan_importer_content_files']) and $form_data['values']['slickplan_importer_content'] === 'contents' and $form_data['values']['slickplan_importer_content_files']),
            'post_type' => isset($form_data['values']['slickplan_importer_post_type']) ? $form_data['values']['slickplan_importer_post_type'] : '',
            'users' => array(),
            'internal_links' => array(),
            'imported_pages' => array()
        );
        foreach ($xml['users'] as $user_id => $user_data) {
            if (isset($form_data['values']['slickplan_importer_users_' . $user_id]) and $form_data['values']['slickplan_importer_users_' . $user_id]) {
